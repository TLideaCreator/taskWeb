...
<script>
    ...
    export default {
        ...
        methods: {
            getTemplateRoles() {
                api.projectSetting.role.getList(this.projectId, roleList => {
            ...
            updateRoleChange(){
                api.projectSetting.role.update(this.updateRole, list=>{
                    this.roleList = list;
                    this.updateRoleDialog = false;
                });
            },
            createRoleChange(){
                api.projectSetting.role.create(this.projectId, this.newRole, list=>{
                    this.roleList = list;
                    this.newRole = {
                        name: '',
                        logo: '',
            ...
            deleteRole(role){
                modal.confirm({
                    ...
                    callback: ()=>{
                        api.projectSetting.role.delete(role, list=>{
                            this.roleList = list;
                            modal.dismiss();
                        })
                    }
