    ...
    export default {
        ...
        methods: {
            dropItem(event) {
                ...
                api.projectSetting.status.updateIndex(this.projectId, {from: fromIndex, to: toIndex}, list => {
                    if (list) {
            ...
            deleteStatusItem(status) {
                modal.confirm({
                    ...
                    callback: () => {
                        api.projectSetting.status.delete(status, list => {
            ...
            getTemplateStatusList() {
                api.projectSetting.status.getList(this.projectId, list => {
                    this.statusList = [...list].sort((a, b) => {
                        return a.indexes - b.indexes
                    });
                })
            ...
            createTemplateStatus() {
                api.projectSetting.status.create(this.projectId, this.newStatus, list => {
            ...
            updateTemplateStatusList() {
                api.projectSetting.status.update(this.editStatus, list => {
